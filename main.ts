let gameSeq: string[] = []; // Sequence of colors for the game
let userSeq: string[] = []; // Sequence of colors entered by the user
...
function gameFlash(btn: HTMLButtonElement) {
...
function userFlash(btn: HTMLButtonElement) {
...
function levelUp() {
    ...
    let randombtn = document.querySelector(`.${randomColor}`) as HTMLButtonElement; // Select the button with the random color
